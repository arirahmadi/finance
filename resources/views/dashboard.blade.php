    ...
    <script>
        ...
        function confirmDeleteTransaction(id, transactionNumber) {
            if (confirm(`Apakah Anda yakin ingin menghapus transaksi ${transactionNumber}?`)) {
                ...
                const subNavSettlements = document.getElementById('sub-nav-settlements');
                const isSettlements = subNavSettlements ? subNavSettlements.classList.contains('active') : false;
